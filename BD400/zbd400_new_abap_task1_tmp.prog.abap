REPORT zbd400_new_abap_task1_tmp.
...
*----------------------------*
  ...
  METHOD _get_fcat.
    ...
    FIELD-SYMBOLS: <fcat> TYPE LINE OF lvc_t_fcat.
  ...
  METHOD _create_output_sum.
    ...
    DATA: lt_output TYPE lcl_app=>tt_output.

    FIELD-SYMBOLS: <out> LIKE LINE OF lt_output,
                   <sum> LIKE LINE OF rt_output_sum.
  ...
  METHOD _create_output.
    ...
    FIELD-SYMBOLS: <vbak> LIKE LINE OF mt_vbak,
                   <vbap> LIKE LINE OF mt_vbap,
                   <makt> LIKE LINE OF mt_makt,
                   <out>  LIKE LINE OF mt_output.
...
* create output itab
**********************************************************************
    LOOP AT ct_vbap ASSIGNING <vbap>.

      AT NEW vbeln.

        " read vbak entry
        READ TABLE ct_vbak ASSIGNING <vbak>
      ...
      READ TABLE ct_makt ASSIGNING <makt>
